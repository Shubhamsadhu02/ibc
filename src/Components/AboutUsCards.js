  ...
  return (
    <>
      <div className="about-container mt-15">
        <div className="about-box1 full-width">
          <div className="about-content1">
            <div className="about-countryFlag mb-4">
            ...
            <div className="about-list">
              <ul>
                ...
                <li>
                  Support domestic manufacturing and job creation for disadvantaged communities
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="about-box1">
          <div className="about-content1">
            ...
            <div className="about-list">
              <ul>
                <li>50 MWh Plant in Production in Korea</li>
                <li>Localized Supply Chain Partners</li>
                <li>IBC Battery Cells are in Commercial Use with Customers in India</li>
              </ul>
            </div>
          </div>
        </div>
